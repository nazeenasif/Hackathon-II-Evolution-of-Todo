      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <Input
            ...
            className="w-full h-10 rounded-md border border-input bg-background text-sm focus:ring-1 focus:ring-primary focus:border-primary"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full h-10 rounded-md border border-input bg-background text-sm px-3 focus:ring-1 focus:ring-primary focus:border-primary"
          >
