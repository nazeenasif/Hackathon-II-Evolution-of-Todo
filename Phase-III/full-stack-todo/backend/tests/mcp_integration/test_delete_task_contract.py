"""
Contract test for the delete_task MCP tool.
...
@pytest.mark.asyncio
async def test_delete_task_contract_valid_params():
    """Test that delete_task accepts valid parameters."""
...
@pytest.mark.asyncio
async def test_delete_task_contract_missing_task_id():
    """Test that delete_task rejects requests without task_id."""
...
@pytest.mark.asyncio
async def test_delete_task_contract_invalid_task_id():
    """Test that delete_task rejects invalid task_id values."""
    invalid_cases = [
        {"task_id": 0},      # Zero
        {"task_id": -1},     # Negative
        {"task_id": "abc"},  # String
